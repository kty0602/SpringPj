...
public class ScheduleController {
    ...
    public ResponseEntity<Schedule> getSchedule(@PathVariable("scheduleId") Long id) {
    ...
    public ResponseEntity<Schedule> modifySchedule(@PathVariable("scheduleId") Long id, @RequestBody ScheduleDto scheduleDto) {
    ...
    public ResponseEntity<String> deleteSchedule(@PathVariable("scheduleId") Long id, @RequestBody ScheduleDto scheduleDto) {
        scheduleService.deleteSchedule(id, scheduleDto);
